    ...
    def load_bullet(self):
        ...
        def on_mouse_press(x, y, button, modifiers):
            if button == mouse.RIGHT:
                ...
                #self.bullet_sprite.dx = 10x_length * self.speed
                #self.bullet_sprite.dy = 10y_length * self.speed
...
class enemy():
    def __init__(self):
        ...
        self.enemy_sprite=pyglet.sprite.Sprite(self.enemy_image,x=100,y=100)
