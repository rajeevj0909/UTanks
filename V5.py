...
class game:
    def __init__(self):
        ...
        #Used trial and error to create size
        self.bullet_image.width = 42
        self.bullet_image.height =67
        #Anchor should be in the middle of the bullet for width
        self.bullet_image.anchor_x = self.tank_image.width / 2
        #Anchor should be at base of bullet
        self.bullet_image.anchor_y = 0
        #The bullet is placed in area away from tank
    ...
    #Load bullet function to draw it
    ...
    def on_draw():
        ...
        #Loads bullet at start of game temporarily
        bullet_object.load_bullet()

tank_object=game()
#An object for bullet has been created
bullet_object=game()
pyglet.app.run()
